    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            lrWorks.on('line', async function (line2) {
                ...
                lineAuthorCodeNumber = await getAuthorNumber(lineJSONData.authorCode);
                lineAuthorName = binarySearch(0, 9515424, lineAuthorCodeNumber).authorName;
